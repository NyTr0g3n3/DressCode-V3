...
export const LoadingSpinner: React.FC<{ className?: string }> = ({ className = "h-8 w-8 text-gold" }) => (
...
export const QuestionMarkIcon: React.FC = () => (
  <svg className="w-8 h-8 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.79 4 4 0 1.132-.497 2.16-1.32 2.874-.823.714-1.823 1.126-2.904 1.126H12v.01M12 17h.01" />
  </svg>
);
...
export const SuitcaseIcon: React.FC = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
        <path d="M8 3a1 1 0 000 2h4a1 1 0 100-2H8z" />
        <path fillRule="evenodd" d="M5 4a3 3 0 00-3 3v6a3 3 0 003 3h10a3 3 0 003-3V7a3 3 0 00-3-3H5zm-1 3a1 1 0 011-1h10a1 1 0 011 1v6a1 1 0 01-1 1H5a1 1 0 01-1-1V7z" clipRule="evenodd" />
    </svg>
);
...
export const HeartIconSolid: React.FC<{ className?: string }> = ({ className = "h-5 w-5" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 20 20" fill="currentColor">
    <path fillRule="evenodd" d="M3.172 5.172a4 4 0 015.656 0L10 6.343l1.172-1.171a4 4 0 115.656 5.656L10 17.657l-6.828-6.829a4 4 0 010-5.656z" clipRule="evenodd" />
  </svg>
);

export const ThumbsDownIcon: React.FC<{ className?: string }> = ({ className = "h-5 w-5" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M17 14V5a2 2 0 00-2-2H9.5a2 2 0 00-1.9 1.4L6 9v5h2.5l1.7 5.3c.2.6.7 1 1.4 1a1.4 1.4 0 001.4-1.4v-.9a2 2 0 012-2H17z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M6 9H4a1 1 0 00-1 1v3a1 1 0 001 1h2" />
  </svg>
);

export const ThumbsDownIconSolid: React.FC<{ className?: string }> = ({ className = "h-5 w-5" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="currentColor">
    <path d="M17 14V5a2 2 0 00-2-2H9.5a2 2 0 00-1.9 1.4L6 9v5h2.5l1.7 5.3c.2.6.7 1 1.4 1a1.4 1.4 0 001.4-1.4v-.9a2 2 0 012-2H17z" />
    <path d="M6 9H4a1 1 0 00-1 1v3a1 1 0 001 1h2z" />
  </svg>
);
