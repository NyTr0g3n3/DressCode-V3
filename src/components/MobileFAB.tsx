        ...
        <div className="bg-white dark:bg-raisin-black rounded-2xl shadow-2xl border border-black/10 dark:border-white/10 overflow-hidden w-56">
          ...
          <label className="block">
            <input
              ...
              className="hidden"
            />
            <div className="flex items-center gap-3 p-4 hover:bg-gold/10 active:bg-gold/20 transition-colors cursor-pointer border-b border-black/5 dark:border-white/5">
          ...
          <label className="block">
            <input
              ...
              className="hidden"
            />
            <div className="flex items-center gap-3 p-4 hover:bg-gray-100 dark:hover:bg-gray-800 active:bg-gray-200 dark:active:bg-gray-700 transition-colors cursor-pointer">
